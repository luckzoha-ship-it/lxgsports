        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              <div 
                key={idx} 
                className="glass-card p-8 rounded-lg flex flex-col justify-between min-h-[320px] border border-dark-border"
              >
                ...
                <div className="pt-6 border-t border-dark-border/40 mt-6">
                  {service.link ? (
                    <Link
                      to={service.link}
                    ...
                    <span className="text-gray-600 font-sans font-bold text-xs uppercase tracking-widest">
                      Standard Offering
                    </span>
                  )}
                </div>
